...
<?php require_once 'maqueta/sliderportal.php'; ?>

<?php require_once 'categoriaslider.php'; ?>

    <div class="site-section bg-light">
      <div class="container">
        <div class="row">
          <div class="col-md-8 mb-5 mb-md-0" data-aos="fade-up" data-aos-delay="100">
            <h2 class="mb-5 h3">Avisos Recientes</h2>
...
<?php require_once 'maqueta/testimonio.php'; ?>

 <?php require_once 'maqueta/eltrabajodetussueños.php'; ?>
    
     <?php require_once 'maqueta/porqueelegirnos.php'; ?>

     <?php require_once 'maqueta/blogreciente.php'; ?>
